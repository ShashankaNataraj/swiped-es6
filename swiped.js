...
function extend() {
    let current = [].shift.call(arguments);
...
Swiped.init = function (o) {
    ...
    let elems = document.querySelectorAll(o.query);
    let group = [];

    delete o.query;

    [].forEach.call(elems, function (elem) {
        let option = extend({elem: elem, group: Swiped.groupCounter}, o);
